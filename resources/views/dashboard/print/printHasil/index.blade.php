...
@section('content')
    <div class="space-y-5">
        ...
        <div class="flex">
        {{-- search --}}
            <form class="w-1/2" action="/printHasil">   
            ...
            <div class="w-full flex">
                <div class="w-2/5">
                    <table class="w-full">
                        <tbody>
                            <tr>
                                <td colspan="2" class="text-center text-4xl">{{ isset($product) ? $product->item : ''  }}</td>
                            </tr>
                            <tr>
